...
def _build_list_item(
    ...
    return ObservatoryEntryListItem(
        ...
        source=ObservatorySourceRef(
            ...
            type=str(entry.source.type.value if hasattr(entry.source.type, "value") else entry.source.type) if entry.source else None,
            category=entry.source.category if entry.source else None,
        ),
        author=entry.author,
