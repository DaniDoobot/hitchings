...
from app.api.v1.endpoints import health, sources, tracking, entries, ingestion_runs, analysis, observatory, auth, admin_users, taxonomy
...
v1_router.include_router(taxonomy.router, prefix="/taxonomy")
